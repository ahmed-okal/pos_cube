...
class OrderItem extends GetView<CategoriesController> {
  const OrderItem({
    ...
    return Obx(
      () => InkWell(
        onTap: () {
          ...
          // controller.expandedItemId.value =
          //     controller.expandedItemId.value == itemId ? -1 : itemId;
        },
                ...
                SizedBox(
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          controller.deleteItemController.deleteItem(itemId);
